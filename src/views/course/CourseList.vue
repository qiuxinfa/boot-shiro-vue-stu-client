...
<!-- 新增属性 -->
	<el-dialog title="新增课程" :visible.sync="dialogFormVisible1">
...
<!-- 		<el-form-item label="报名时间">
		...
		<el-form-item label="报名开始" prop="signStime2" :rules="[{ required: true, message: '请输入课程名称', trigger: 'blur' }]">
			<el-input type="date" v-model="attr.signStime2"></el-input>
		</el-form-item>
		<el-form-item label="报名结束" prop="signEtime2" :rules="[{ required: true, message: '请输入课程名称', trigger: 'blur' }]">
			<el-input type="date" v-model="attr.signEtime2"> </el-input>
		</el-form-item>		
		<el-form-item label="考试开始" prop="examStime2" :rules="[{ required: true, message: '请输入课程名称', trigger: 'blur' }]">
			<el-input type="date" v-model="attr.examStime2"></el-input>
		</el-form-item>
		<el-form-item label="考试结束" prop="examEtime2" :rules="[{ required: true, message: '请输入课程名称', trigger: 'blur' }]">
...
export default {
	...
	methods: {
		...
		async addCourse() {
			...
			if(stime>etime){
				 _this.message(true,'报名开始时间不能在报名结束时间之后','error')
				 return
			}
			...
			let params = {
				...
				signStime: _this.attr.signStime2,
				signEtime: _this.attr.signEtime2,
				examStime: _this.attr.examStime2,
				examEtime: _this.attr.examEtime2
			}
