...
function() { !
    function() {
        ...
        b = {
            ...
            extend: function(a, b) {
                for (var c = arguments,
                d = !!this.isBoolean(c[c.length - 1]) && c[c.length - 1], e = this.isBoolean(c[c.length - 1]) ? c.length - 1 : c.length, f = 1; f < e; f++) {
                    var g = c[f];
            ...
            addClass: function(a, c) {
                if (a) {
                    ...
                    for (var d, e = 0,
                    f = a.className; d = c[e++];) new RegExp("\\b" + d + "\\b").test(f) || (f += " " + d);
    ...
    function(a) {
        ...
        function c(b, c, e) {
            for (var f = b.rows,
            g = [], h = "TH" === f[0].cells[0].tagName, i = 0, j = 0, k = f.length; j < k; j++) g[j] = f[j];
            var l = {
    ...
    function(a) {
        ...
        function l(a) {
            ...
            if ("1" != f.dataFormat) {
                for (var g = 0,
                h = e.length; g < h; g++) for (var i = 0,
                j = e[g].length; i < j; i++) d[i] || (d[i] = []),
                d[i][g] = e[g][i];
                e = d
            }
            if (d = {},
    ...
    function(a) {
        for (var b, c, d = this,
        e = d.root,
        f = e.getElementsByTagName("p"), g = 0; c = f[g++];) b = c.getAttribute("data-background"),
    ...
    function(a) {
        ...
        (f.length || g.length) && (c.push(h + " .list-paddingleft-1{padding-left:0}"), c.push(h + " .list-paddingleft-2{padding-left:" + this.listDefaultPaddingLeft + "px}"), c.push(h + " .list-paddingleft-3{padding-left:" + 2 * this.listDefaultPaddingLeft + "px}"), a.cssRule("list", h + " ol," + h + " ul{margin:0;padding:0;}li{clear:both;}" + c.join("\n"), document))
    }),
